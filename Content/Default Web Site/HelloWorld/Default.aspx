<%@ Page Language="VB" %>
    ...
    <head>
        ...
        <title>Hello World! - My first app</title>
        <meta name="viewport" content="width=device-width" />
        <link type="image/png" href="favicon.png?v=1" rel="icon">
        <link type="image/png" href="favicon.png?v=1" rel="apple-touch-icon">
        <link type="image/png" href="favicon.png?v=1" rel="shortcut icon">
        <link href="optimum/css/829e05b9f41f6bb84f45efee62d5042f.out.css" rel="stylesheet" type="text/css" />
        <link href="optimum/css/e33d07d014c6673622d983e449fce699.addon.b64.css" rel="stylesheet" type="text/css" />
    </head>
        ...
        <div class="wrapper">
            ...
            <div class="page">
                <div class="header">
                    <h1>Hello World</h1>
                    <h2>You did it!</h2>
                    <h3>Your application is now running in the Cloud!</h3>
                    <div class="nodename">
                        <%= System.Environment.MachineName %>
                    </div>
                </div>
                <div class="hw-separator"></div>
                <div class="links-block-title">Useful links</div>
                <div class="links-block">
                    <ul class="links">
                        <li><a target="_blank"
                                href="https://www.virtuozzo.com/application-platform-docs/jelastic-dashboard-guide">Dashboard
                                Guide</a></li>
                        <li><a target="_blank"
                                href="https://www.virtuozzo.com/application-platform-docs/net-core/#deploying-application-to-net-core-server">Deploy
                                .NET Projects via GIT or SVN</a></li>
                        <li><a target="_blank"
                                href="https://www.virtuozzo.com/application-platform-docs/deployment-guide/#archive-deployment-configurations">Upload
                                your own .NET application</a></li>
                        <li><a target="_blank"
                                href="https://www.virtuozzo.com/application-platform-docs/configuration-file-manager/">Application
                                Configuration</a></li>
                    </ul>
                    <ul class="links">
                        <li><a target="_blank"
                                href="https://www.virtuozzo.com/application-platform-docs/ssh-access/">SSH Access</a>
                        </li>
                        <li><a target="_blank"
                                href="https://www.virtuozzo.com/application-platform-docs/ftp-ftps-support/">FTP/FTPS
                                Support</a></li>
                        <li><a target="_blank"
                                href="https://www.virtuozzo.com/application-platform-docs/resource-consumption/">Charged
                                Resources</a></li>
                        <li><a target="_blank"
                                href="https://www.virtuozzo.com/application-platform-docs/pricing-model/">Pricing
                                Model</a></li>
                    </ul>
                </div>
                <div class="hw-separator"></div>
                <div class="share">
                    <div class="social"> <a target="_blank" href="https://www.facebook.com/VirtuozzoInc/"
                            class="facebook"> <svg enable-background="new 0 0 310 310" version="1.1"
                                viewBox="0 0 310 310" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            </svg> </a> <a target="_blank" href="https://www.linkedin.com/company/virtuozzo"
                            class="linkedin"> <svg enable-background="new 0 0 310 310" version="1.1"
                                viewBox="0 0 310 310" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            </svg> </a> <a target="_blank" href="https://twitter.com/virtuozzoinc" class="twitter"> <svg
                                enable-background="new 0 0 310 310" version="1.1" viewBox="0 0 310 310"
                ...
                <div class="footer"> &copy; <a id="footer-link" href="https://www.virtuozzo.com/application-platform/"
                        target="_blank">Virtuozzo</a>. All rights reserved. | <a class="company-legal"
                        href="https://www.virtuozzo.com/legal/" target="_blank">Privacy & Legal</a> </div>
            </div>
